...
from owl_config import METRICS_PUSH_ADDR
from owl_config import METRICS_PUSH_PORT
...
class FalconCli(object):
    ...
    @classmethod
    def connect(cls, server=METRICS_PUSH_ADDR, port=METRICS_PUSH_PORT,
      debug=True, buf_size=1000):
        try:
